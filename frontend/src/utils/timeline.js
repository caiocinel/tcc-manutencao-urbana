...
export function getTimelineItems(d) {
  const items = [{ id: 'criado', active: true, title: 'Chamado Criado', description: d.descricao?.slice(0, 120), date: new Date(d.criado_em).toLocaleString(), meta: `Por ${maskName(d.usuario?.nome)}` }];
