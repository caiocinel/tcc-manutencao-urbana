        ...
        <div className="field">
          ...
          <div style={{ position: 'relative' }}>
            <input
              ...
              style={{ borderColor: cpfValido === true ? 'var(--color-success)' : cpfValido === false ? 'var(--color-error)' : undefined }}
            />
            <span style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', fontSize: 11 }}>
              {cpfValidando && <span style={{ color: 'var(--color-text-tertiary)' }}>Validando...</span>}
              {cpfValido === true && <span style={{ color: 'var(--color-success)' }}>OK</span>}
              {cpfValido === false && <span style={{ color: 'var(--color-error)' }}>Inválido</span>}
            </span>
          </div>
        </div>
